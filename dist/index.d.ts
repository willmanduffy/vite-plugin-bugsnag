...
interface BuildReporterConfig extends Build, ReportBuildOptions {
    /**
...
declare function BugsnagBuildReporterPlugin(config: BuildReporterConfig): Plugin;

declare function BugsnagSourceMapUploaderPlugin(config: SourceMapUploaderConfig): Plugin;

export { BugsnagBuildReporterPlugin, BugsnagSourceMapUploaderPlugin, Build, BuildReporterConfig, ReportBuildOptions, SourceMapUploaderConfig, Sourcemap };
